...
function sumArray(sumArr) { //eslint-disable-line
  var sumOfArray = [];
  var sumR = sum(sumArr[0],sumArr[1]);
  console.log(sumR);
  var finalSum= sum(sumR[0],sumArr[2]);
  console.log(finalSum);
  sumOfArray[0]=finalSum[0];
  console.log(sumOfArray[0]);
  sumOfArray[1]= `${sumArr[0]},${sumArr[1]},${sumArr[2]} was passed in as an array of numbers, and ${finalSum[0]} is their sum.`
  console.log('final answer ' + sumOfArray);
  return sumOfArray;
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  var multiArray2 = multiply(multArr[0],multArr[1]);
  var finalMultArray = multiply(multiArray2[0],multArr[2]);
  multiplyOfArray[0] = finalMultArray[0];

  multiplyOfArray[1]= `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of 24.`
